...
func moveToDataBase() throws {
        ...
        parseCSV_groups(data_file: "data/films_mean_level", topic_name: "Films")
        ...
        parseCSV_groups(data_file: "data/vehicles_mean_level", topic_name: "Vehicles")
        ...
        parseCSV_words(data_file: "data/films", topic_name: "Films")
        ...
        parseCSV_words(data_file: "data/vehicles", topic_name: "Vehicles")
